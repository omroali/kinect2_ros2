...
# Copyright (c) 2024
# Simplified Dual Kinect v2 Launch File for ROS 2
#
# This launch file uses hardcoded serial numbers to avoid
# ROS 2 parameter type conversion issues with leading zeros.
#
# To customize for your Kinects, edit SERIAL_KINECT_1 and SERIAL_KINECT_2 below.
...
# ============================================================
# CONFIGURE YOUR KINECT SERIAL NUMBERS HERE
# ============================================================
# To find your serials: lsusb -v -d 045e:02c4 2>/dev/null | grep iSerial
#
# SOLUTION: Specify serial for kinect2_1, use empty string for kinect2_2
# Empty string "" makes it auto-detect the first available (not already in use)
#
SERIAL_KINECT_1 = "007425354147"  # First Kinect - specify working serial
SERIAL_KINECT_2 = ""              # Second Kinect - auto-detect remaining device
#
# This avoids ROS 2 YAML parameter issues with serials that have leading zeros.
# The first Kinect opens with the specified serial, the second auto-selects
# the other available device.
#
# To use explicit serials for both (if needed):
# SERIAL_KINECT_1 = "007425354147"
# SERIAL_KINECT_2 = "001934470647"
# ============================================================
...
def generate_launch_description():
    ...
    # SERIAL IS HARDCODED AS STRING TO AVOID TYPE CONVERSION
                ...
                parameters=[
                    {
                        ...
                        "sensor": SERIAL_KINECT_1,  # Hardcoded string
                        "publish_tf": True,
                ...
                parameters=[
                    {
                        ...
                        "sensor": SERIAL_KINECT_2,  # Hardcoded string
                        "publish_tf": True,
